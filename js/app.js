(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".expedition__slider")) new core(".expedition__slider", {
            ...
            if (document.querySelector(".destination__slider")) new core(".destination__slider", {
...
***************************************************************************** */
        ...
        (function() {
            ...
            function trackScroll() {
                ...
                if (scrolled > coords) goTopBtn.classList.add("noselect-show");
                if (scrolled < coords) goTopBtn.classList.remove("noselect-show");
            }
            function backToTop() {
